...
PCfile = fullfile(projectDir, 'objsmooth', ['heartPC',num2str(fileMeta.timePoints(1)),'_ilastik.obj']);
outputMesh = fullfile(projectDir, 'objsmooth',['heartPC',num2str(fileMeta.timePoints(1)),'_ilastik_mesh.obj']);
meshlabScript = fullfile(projectDir, 'heartTest3.mlx');
...
%% 
onionOpts = struct('nLayers', 21, 'layerDistance', 3, 'sigma', 20);
...
%
imwriteOptions = {'tif'};
saveDir = fullfile(projectDir, 'heartIlastik');
...
for t = 61:129
    ...
    outputMesh = fullfile(projectDir, 'objsmooth',['heartPC',num2str(fileMeta.timePoints(t)),'_ilastik_mesh.obj']);
...
for t = 1 : 129
    ...
    imwrite(mip, ['mipsIlastik/Cyl2_p_',num2str(t),'.tif'], 'Compression','none');
